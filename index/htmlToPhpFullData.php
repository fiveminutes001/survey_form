...
$pdf->AddPage();
	...
	$footer_image_file = 'logo/logo.png';
	$footer_logo_html = '
	<table border="none" cellspacing="0" cellpadding="5">
	<tr>
		<th width ="70%"><u>Your Response:</u></th>
		<th width ="30%"><div style="width:100% !important;height:100px;float:right;"><img width:"100%;" src="' . $footer_image_file . '" /></div></th>
	</tr>
	</table>';

	$content .= $footer_logo_html;
	$content .= '
    <h3 align="center">REPORT TO USER</h3>
    <h3 align="left"><u>Background Information</u></h3>
	<table border="1" cellspacing="0" cellpadding="5">
	<tr>
		<th width ="15%"><u>Risk factor</u></th>
		<th width ="15%"><u>Your Response:</u></th>
		<th width ="70%"><u>Explanation and References</u></th>
    </tr>

    <tr>
		<td width ="15%">Age</td>
		<td width ="15%">'.$post_result["age"].'</td>
    ...
    <tr>
        <td width ="15%">Sex</td>
        <td width ="15%">'.$post_result["sex"].'</td>
        <td width ="70%">Women are more impacted by Alzheimer’s disease than men – they are at significantly greater risk of developing Alzheimer’s disease, and recent research shows that they also appear to suffer a greater cognitive decline than men at the same age. Explanations have been linked to a variety of factors including differences in cognitive reserve, resilience, as well as genetics (Apolipoprotein e4) and functional and structural brain changes.[2]</td>
    </tr>

    <tr>
        <td width ="15%">Education</td>
        <td width ="15%">'.$post_result["education"].'</td>
        <td width ="70%">Higher education levels provide some preventive benefit against Alzheimer’s and dementia. Scientists also believe that more years of education builds a “cognitive reserve” in the brain, which can enable a person to compensate better during the early stages of the disease. [3]
    ...
    <tr>
        <td width ="15%">Positive Family history</td>
        <td width ="15%">'.$post_result["dementia_family_history"].'</td>
        <td width ="70%">Family History of Alzheimer’s Having a parent, brother, or sister diagnosed with Alzheimer’s increases the risk of developing the disease.
	...
	<tr>
		...
		<th width ="15%"><u>Your Response:</u></th>
		<th width ="66%"><u>Explanation and References</u></th>
    </tr>

    <tr>
		<td>Weight and Height</td>
		<td>'.$post_result["BMI"].' and '.$post_result["BMI_CAT"].'</td>
    ...
    <tr>
		...
		<td>'.$post_result["HEALTHY_DIET_CAT"].'</td>
    ...
    <tr>
		...
		<td>'.$post_result["PHYSICAL_ACTIVITY_CAT"].'</td>
    ...
    <tr>
		...
		<td>'.$post_result["COGNITIVE_ACTIVITY_SCORE"].'</td>
    ...
    <tr>
     ...
     <tr>
		<td>Hypertension</td>
		<td>'.$post_result["hypertension"].'</td>
  ...
  <tr>
     ...
     <td>'.$post_result["cardiovascular"].'</td>
  ...
  <tr>
     ...
     <td>'.$post_result["renal_dysfunction"].'</td>
     ...
     <p style="margin:0px;"><u>Age:</u>'.$post_result["age"].' years</p>
     <p style="margin:0px;"><u>Sex:</u>'.$post_result["sex"].'</p>
     <p style="margin:0px;"><u>Education:</u>'.$post_result["education"].' years</p>
     <p style="margin:0px;"><u>Family history of early dementia1 or genetic predisposition:</u> '.$post_result["dementia_family_history"].'</p>
     <br>
     <h4><u>Lifestyle Factors</u></h4>
     <p style="margin:0px;"><u>BMI</u>= '.$post_result["BMI_CAT"].'</p>
     <p style="margin:0px;"><u>Healthy Diet:</u> '.$post_result["HEALTHY_DIET_CAT"].'</p>
     <p style="margin:0px;"><u>Alcohol:</u> '.$post_result["ALCOHOL_CAT"].'</p>
     <p style="margin:0px;"><u>Smoking:</u> '.$post_result["smoking"].'</p>
     <p style="margin:0px;"><u>Physical activity:</u> '.$post_result["PHYSICAL_ACTIVITY_CAT"].'</p>
     <p style="margin:0px;"><u>Cognitive activity:</u>: '.$post_result["COGNITIVE_ACTIVITY_SCORE"].'</p>
     <p style="margin:0px;"><u>Sleep:</u> '.$post_result["SLEEP_CAT"].'</p>
     <br>';
	...
	if($post_result["diabetes"] == 'Yes' || $post_result["cholesterol"] == 'Yes' || $post_result["hypertension"] == 'Yes' || $post_result["depression"] == 'Yes' || $post_result["heart"] == 'Yes' || $post_result["cardiovascular"] == 'Yes' || $post_result["renal_dysfunction"] == 'Yes') {
     ...
     <h3>References</h3>
     <p style="margin:0px;">[1]. Alzheimer’s Society. Risk Factors for Dementia, Factsheet 450LP April 2016. https://www.alzheimers.org.uk/sites/default/files/pdf/factsheet_risk_factors_for_dementia.pdf</p>
     <p style="margin:0px;">[2]. Laws KR, et al. Sex differences in Alzheimer’s disease. Curr Opin Psychiatry 2018; 31:133–139.</p>
     <p style="margin:0px;">[3]. Stern Y. Cognitive reserve in ageing and Alzheimer’s disease. Lancet Neurol 2012;11(11):1006–12.</p>
     <p style="margin:0px;">[4]. Wei Xu et al. Education and Risk of Dementia: Dose-Response Meta-Analysis of Prospective Cohort Studies. Mol Neurobiol 2016; 53:3113–3123</p> 
     <p style="margin:0px;">[5]. NIH National Institute on Aging. What Causes Alzheimer\'s Disease? National Institutes of Health, May 2017. https://www.nia.nih.gov/health/what-causes-alzheimers-disease</p>
     <p style="margin:0px;">[6]. NIH National Institute on Aging. Alzheimer\'s Disease Genetics Fact Sheet. National Institutes of Health, October 2015. https://www.nia.nih.gov/health/alzheimers-disease-genetics-fact-sheet#genetics</p>
     <p style="margin:0px;">[7]. Pedditizi E et al. The risk of overweight/obesity in mid-life and late life for the development of dementia: a systematic review and meta-analysis of longitudinal studies. Age and Ageing 2016; 45:14–21</p>
     <p style="margin:0px;">[8]. Ntlholang O, et al. The relationship between adiposity and cognitive function in a large community-dwelling population: Data from the Trinity Ulster Department of Agriculture (TUDA) ageing cohort study. British Journal of Nutrition 2018; 120(5):517-527.</p> 
     <p style="margin:0px;">[9]. Solfrizzi V, Panza F, Frisardi V, Seripa D, et al. Diet and Alzheimer\'s Disease Risk Factors or Prevention: The Current Evidence. Expert Rev Neurother 2011 May;11(5):677-708.Review</p> 
     <p style="margin:0px;">[10]. Greenwood CE, Parrott MD. Nutrition as a component of dementia risk reduction strategies. Healthcare Management Forum 2017; 30(1): 40–45.</p>
     <p style="margin:0px;">[11]. https://www.alzheimers.net/4-8-15-mind-diet-alzheimers-prevention/</p>
     <p style="margin:0px;">[12]. Sabia S, et al. Alcohol consumption and risk of dementia: 23 year follow-up of Whitehall II cohort study. BMJ 2018; 362 :k2927</p>
     <p style="margin:0px;">[13]. Ruitenberg A, van Swieten JC, Witteman JC, Mehta KM, van Duijn CM, HofmanA et al. Alcohol consumption and risk of dementia: the Rotterdam Study. Lancet 2002; 359(9303):281-286.</p>
     <p style="margin:0px;">[14]. Cataldo JK, Prochaska JJ, Glantz SA. Cigarette smoking is a risk factor for Alzheimer\'s Disease: an analysis controlling for tobacco industry affiliation. J Alzheimers Dis 2010; 19(2):465-80.</p>
     <p style="margin:0px;">[15]. Zhong G et al. Smoking Is Associated with an Increased Risk of Dementia: A Meta-Analysis of Prospective Cohort Studies with Investigation of Potential Effect Modifiers. PLoS ONE 2015; 10 (3): e0118333.</p>
     <p style="margin:0px;">[16]. Larson EB, Wang L, Bowen JD, McCormick WC, et al. Exercise is associated with reduced risk for incident dementia among persons 65 years of age and older. Ann Intern Med 2006;144(2):73–81.</p>
     <p style="margin:0px;">[17]. Xu W, Wang HF, Wan Y, et al. Leisure time physical activity and dementia risk: a dose response meta-analysis of prospective studies. BMJ Open 2017; 7</p>
     <p style="margin:0px;">[18]. Hall CB, Lipton RB, Sliwinski M, Katz MJ, Derby CA, Verghese J. Cognitive activities delay onset of memory decline in persons who develop dementia. Neurology 2009;73:356–61.</p>
     <p style="margin:0px;">[19]. Lee ATC, Richards M, Chan WC, Chiu HFK, Lee RSY, Lam LCW. Association of Daily Intellectual Activities With Lower Risk of Incident Dementia Among Older Chinese Adults. JAMA Psychiatry 2018;  75(7):697–703.</p>
     <p style="margin:0px;">[20]. Meerlo P, Sgoifo A, Suchecki D. Restricted and disrupted sleep: effects on autonomic function, neuroendocrine stress systems and stress responsivity. Sleep Med Rev. 2008 Jun;12(3):197-210</p>
     <p style="margin:0px;">[21]. Le Shi et al. Sleep disturbances increase the risk of dementia: A systematic review and meta-analysis. Sleep Medicine Reviews 2018; 40: 4-16.</p>
     <p style="margin:0px;">[22]. Ohara T, Doi Y, Ninomiya T, Hirakawa Y, Hata J, Iwaki T, et al. Glucose tolerance status and risk of dementia in the community: The Hisayama Study. Neurology 2011(77):1126–34.</p>
     <p style="margin:0px;">[23]. Solomon A, Kivipelto M, Wolozin B, Zhou, J, Whitmer, RA. Midlife serum cholesterol and increased risk of Alzheimer’s and vascular dementia three decades later. Dement and GeriatrDisord 2009;28:75–80.</p>
     <p style="margin:0px;">[24]. Song Y, Nie H, Xu Y, et al. Association of statin use with risk of dementia: a meta-analysis of prospective cohort studies. Geriatr Gerontol Int 2013; 13: 817–824.</p>
     <p style="margin:0px;">[25]. Launer LJ, Ross GW, Petrovitch H, Masaki K, Foley D, White LR, et al. Midlife blood pressure and dementia: The Honolulu-Asia Aging Study. Neurobiol Aging 2000;21(1):49–55.</p> 
     <p style="margin:0px;">[26]. Kjeldsen SE, Narkiewicz K, Burnier M, Oparil S. Intensive blood pressure lowering prevents mild cognitive impairment and possible dementia and slows development of white matter lesions in brain: the SPRINT Memory and Cognition IN Decreased Hypertension (SPRINT MIND) study. Blood Press 2018; 27:247-248.</p>
     <p style="margin:0px;">[27]. Wang HX, Karp A, Winblad B, Fratiglioni L. Late-life engagement in social and leisure activities is associated with a decreased risk of dementia. Am J Epidemiol 2002;155(12):1081–7.</p>
     <p style="margin:0px;">[28]. Boyle PA, Buchman AS, Barnes LL, et al. Effect of a purpose in life on risk of incident Alzheimer disease and mild cognitive impairment in community dwelling older persons. Arch Gen Psychiatry 2010; 67:304–10.</p>
     <p style="margin:0px;">[29]. Lyall DM, et al. Associations between single and multiple cardiometabolic diseases and cognitive abilities in 474 129 UK Biobank participants. Eur Heart J 2017; 38:577–583.</p>
     <p style="margin:0px;">[30]. Samieri C et al. Association of cardiovascular health level in older age with cognitive decline and incident dementia. JAMA 2018 Aug 21; 320:657.</p>
     <p style="margin:0px;">[31]. Saver JL et al. Striving for Ideal Cardiovascular and Brain Health It Is Never Too Early or Too Late. JAMA 2018 August 21; 320:645.</p>
     <p style="margin:0px;">[32]. Etgen T. Kidney disease as a determinant of cognitive decline and dementia. Alzheimers Res Ther 2015; 7(1): 29.</p>
...
//REPORT MAIL//OUTPUT 6//MAIL 1
	...
	$path = __DIR__ . '/forms/';
	$mailto = 'sivan2902@gmail.com, fiveminutes001@gmail.com';
	$from_mail = 'registration@explainit.online';
	$from_name = 'survey form ';
	$replyto = 'registration@explainit.online'; 
	$subject = 'Survey Form'; 
	$post_result["first_name"] = 'John';
	$message = 'Dear '.$post_result["first_name"].',
 
		Thank you for completing our Brain Health survey. 
		...
		of life as you age.
		 
		The first thing we say to all our participants who complete this survey is… don’t worry, you can always aim for
		a better brain!
		...
		* The Brain Risk Assessment (BRA): A detailed survey tool with more than 200 questions (ten domain
		...
		* The Personal Brain-Health Plan (PHP): Following a scheduled conference call with our experts a
		roadmap for the desired changes (i.e., short- and long-term personal goals) in lifestyle will be
		formulated.
		* The Coach Plan (COACH): A subscription plan which offers continuous coaching and monitoring of
		...
		Sincerely,
		The BrainFit Resorts Team
		
		Email:                   web@brainfitresorts.com
		Address:               114 Lavender Street
		                              #09-88 CT Hub 2
		                              Singapore 338729
		Website:               https://www.brainfitresorts.com';
